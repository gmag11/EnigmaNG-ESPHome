...
#endif
#ifdef USE_ENIGMANG
#include "esphome/components/enigmang/enigmang.h"
#endif
...
#ifdef USE_ENIGMANG
  if (enigmang::global_enigmang_component != nullptr)
    return enigmang::global_enigmang_component->is_connected();
#endif
...
#ifdef USE_ENIGMANG
  return enigmang::global_enigmang_component->get_use_address();
#endif
...
#if !defined(USE_ETHERNET) && !defined(USE_MODEM) && !defined(USE_WIFI) && !defined(USE_OPENTHREAD) && !defined(USE_ENIGMANG)
